...
def resolve_labels_meta_path() -> str:
  """
  Busca labels_meta.json en varias ubicaciones razonables.
  Prioridad: ENV -> path relativo 'ia/labels_meta.json' -> 'labels_meta.json' -> 'modelos/labels_meta.json'
  """
...
# Ruta meta etiquetas (con resolución robusta)
...
NUMERIC_COLS: List[str] = safe_load_json(NUMERIC_COLS_PATH)   # 62
FLAGS_ORDER: List[str]  = safe_load_json(FLAGS_PATH)           # 3
FEATURES_ORDER: List[str] = safe_load_json(FEATURES_PATH)      # 65
